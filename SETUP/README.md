...
1.  Create (or re-use) a
    [Google Cloud billing account](https://console.cloud.google.com/billing/linkedaccount?project=cdp-example-hbkeecyi)
    and attach it to the newly created project (cdp-example-hbkeecyi).
...
1.  Generate a Google Service Account JSON Key for your Google Cloud Project.
    ...
    add a file called `cdp-example-hbkeecyi.json` to it
    (i.e. `.keys/cdp-example-hbkeecyi)`. This file will be used later on.
...
1.  Attach the Pulumi Access Token and the
    ...
    -   Set the value to: the contents of the file `.keys/cdp-example-hbkeecyi.json`
    -   Click "Add secret"
...
1.  Once the
    ...
    -   Navigate to [Firebase Console](https://console.firebase.google.com),
        login to the Google Account you used during step #2, select the `cdp-example-hbkeecyi` Firebase project
